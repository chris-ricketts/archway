...
type TransactionTracking struct {
	...
	IsEligibleForRewards  bool                   `protobuf:"varint,5,opt,name=is_eligible_for_rewards,json=isEligibleForRewards,proto3" json:"is_eligible_for_rewards,omitempty"`
}
...
type ContractInstanceSystemMetadata struct {
	...
	BlockTxCounter   []byte           `protobuf:"bytes,2,opt,name=block_tx_counter,json=blockTxCounter,proto3" json:"block_tx_counter,omitempty"`
}
...
func (m *ContractInstanceSystemMetadata) GetBlockTxCounter() []byte {
	if m != nil {
		return m.BlockTxCounter
	}
	return nil
}
...
type WasmMsg struct {
	Type WasmMsgType `protobuf:"varint,1,opt,name=type,proto3,enum=archway.gastracker.v1.WasmMsgType" json:"type,omitempty"`
...
func (m *WasmMsg) GetType() WasmMsgType {
	if m != nil {
		return m.Type
	}
...
func (m *ContractValidFeeGranteeMsg) GetGrantee() string {
	if m != nil {
		return m.Grantee
	}
	return ""
...
func (m *ContractValidFeeGranteeMsg) GetGasFeeToGrant() []*types.Coin {
	if m != nil {
...
func (m *ContractValidFeeGranteeMsg) GetMsgs() []*WasmMsg {
	if m != nil {
		return m.Msgs
	}
	return nil
...
var fileDescriptor_ef6eeaf5a864e490 = []byte{
	...
	,
}
...
func (m *ContractInstanceSystemMetadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BlockTxCounter) > 0 {
		i -= len(m.BlockTxCounter)
		copy(dAtA[i:], m.BlockTxCounter)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.BlockTxCounter)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *ContractInstanceSystemMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockTxCounter", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BlockTxCounter = append(m.BlockTxCounter[:0], dAtA[iNdEx:postIndex]...)
			if m.BlockTxCounter == nil {
				m.BlockTxCounter = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= WasmMsgType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
